(function(){
  ...
  //Makes 10 different messages using generateMessage function and adds it to the geemails array
  ...
  //This the Main Function. It creates a message object with random date, subject, sender, and body;
  ...
  //Used by generateMessage function to generate random subject, sender, and body. arr is the subject
  function getRandomElement(arr){
    return arr[Math.floor(Math.random() * arr.length)];
  }

  //Creates a new message with the values from generateMessage
  function getNewMessage(){
    var now = new Date();
    return generateMessage(now);
  }

  //Used by generateMessage to generate a random date
